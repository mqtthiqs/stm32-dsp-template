...
class WavWriter {
 ...
 public:
  ...
  void Write(Buffer<T, size>& output) {
    fwrite(output.begin().repr(), sizeof(T), size, fp);
  }
};
...
class WavReader {
 ...
 public:
  WavReader(const char* filename) {
    ...
    if (!(fread(data, 1, 4, fp) == 4 && data[0] == 'R' && data[1] == 'I' && data[2] == 'F' &&
          data[3] == 'F')) {
    ...
    if (!(fread(data, 1, 8, fp) == 8 && data[0] == 'W' && data[1] == 'A' && data[2] == 'V' &&
          data[3] == 'E' && data[4] == 'f' && data[5] == 'm' && data[6] == 't' && data[7] == ' ')) {
    ...
    if (!(fread(data, 1, 4, fp) == 4 && data[0] == 'd' && data[1] == 'a' && data[2] == 't' &&
          data[3] == 'a')) {
